 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "friendidentifier.teo", ownerName = "friendidentifier.teo", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyBmzuBbO_6NEPWvAnuJiT6kvrIfWmXYIuE";
